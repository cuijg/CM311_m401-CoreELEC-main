...
systemd_path2="${system_root}/lib/firmware/rtl_bt/"
...
mount
mount / -o rw,remount /root/CM311_m401-CoreELEC-main/target
mount / -o rw,remount
...
sudo cp ${common_files}/bluetooth.service ${systemd_path2}/bluetooth.service
sudo chown root:root ${systemd_path}/bluetooth.service
sudo chmod 0777 ${systemd_path}/bluetooth.service

echo "Copying systemd service file for uwe5621ds"
sudo cp ${common_files}/rtl8761b_config.bin ${systemd_path2}/rtl8761b_config.bin
sudo chown root:root ${systemd_path2}/rtl8761b_config.bin
sudo chmod 0777 ${systemd_path2}/rtl8761b_config.bin
sudo cp ${common_files}/rtl8761b_fw.bin ${systemd_path2}/rtl8761b_fw.bin
sudo chown root:root ${systemd_path2}/rtl8761b_fw.bin
sudo chmod 0777 ${systemd_path2}/rtl8761b_fw.bin
...
#sudo mksquashfs ${system_root} SYSTEM -comp lzo  -Xcompression-level 9 -b 524288 -no-xattrs
sudo mksquashfs ${system_root} SYSTEM -comp lzo -b 524288 -no-xattrs
